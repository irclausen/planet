...
const baseTimeoutPost: object = { id: 0, title: "", chain: "", creator: "" };

export const TimeoutPost = {
  encode(message: TimeoutPost, writer: Writer = Writer.create()): Writer {
    if (message.id !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): TimeoutPost {
    ...
    const message = { ...baseTimeoutPost } as TimeoutPost;
