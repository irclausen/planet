...
func init() {
	proto.RegisterType((*BlogPacketData)(nil), "irclausen.planet.blog.BlogPacketData")
	proto.RegisterType((*NoData)(nil), "irclausen.planet.blog.NoData")
	proto.RegisterType((*IbcPostPacketData)(nil), "irclausen.planet.blog.IbcPostPacketData")
	proto.RegisterType((*IbcPostPacketAck)(nil), "irclausen.planet.blog.IbcPostPacketAck")
}
...
var fileDescriptor_bcaa85416e29107a = []byte{
	...
	0x2c, 0x4a, 0xce, 0x49, 0x2c, 0x2d, 0x4e, 0xcd, 0xd3, 0x2b, 0xc8, 0x49, 0xcc, 0x4b, 0x2d, 0xd1,
	...
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x2c, 0x34, 0x99, 0xb7, 0x99, 0x01, 0x00, 0x00,
}
