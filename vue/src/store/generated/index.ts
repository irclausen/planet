...
import IrclausenPlanetIrclausenPlanetBlog from './irclausen/planet/irclausen.planet.blog'
...
export default { 
  ...
  IrclausenPlanetIrclausenPlanetBlog: load(IrclausenPlanetIrclausenPlanetBlog, 'irclausen.planet.blog'),
